...
MONGOcm now supports full decentralized budgets that are paid directly from the blockchain via superblocks once per month.
...
mnbudget prepare \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mongocm_address\> \<monthly_payment_mongocm\> [use_ix(true|false)]
...
In this transaction we prepare collateral for "_cool-project_". This proposal will pay _1200_ MONGOcm, _12_ times over the course of a year totaling _24000_ MONGOcm.
...
mnbudget submit \<proposal-name\> \<url\> \<payment_count\> \<block_start\> \<mongocm_address\> \<monthly_payment_mongocm\> \<collateral_hash\>
...
When block `1000000` is reached you'll receive a payment for `1200` MONGOcm.
