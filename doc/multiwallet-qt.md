...
In order to support loading of multiple wallets in mongocm-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is mongocm.cpp.
...
Changes to mongocm.cpp
----------------------
mongocm.cpp is the entry point into mongocm-qt, and as such, will require some minor modifications to provide hooks for
