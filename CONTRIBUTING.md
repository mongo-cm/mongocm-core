Contributing to MONGOcm Core
============================

The MONGOcm Core project operates an open contributor model where anyone is
...
The following applies to code changes to the MONGOcm Core project, and is not to be
confused with overall MONGOcm Network Protocol consensus changes.

Whether a pull request is merged into MONGOcm Core rests with the project merge
...
Patches that change MONGOcm consensus rules are considerably more involved than
...
Where a patch set proposes to change the MONGOcm consensus, it must have been
...
The project leader is the release manager for each MONGOcm Core release.
