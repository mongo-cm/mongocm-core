...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MONGOcm Core mongocm-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  mongocm-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded mongocm transaction") + "\n" +
                               "  mongocm-tx [options] -create [commands]   " + _("Create hex-encoded mongocm transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded mongocm transaction
