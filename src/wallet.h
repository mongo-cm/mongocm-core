...
enum AvailableCoinsType {
    ALL_COINS = 1,
    ONLY_DENOMINATED = 2,
    ONLY_NOT250000IFMN = 3,
    ONLY_NONDENOMINATED_NOT250000IFMN = 4, 	// ONLY_NONDENOMINATED and not 250000 MONGOcm at the same time
    ONLY_250000 = 5,                        // find masternode outputs including locked ones (use with caution)
    STAKABLE_COINS = 6                      // UTXO's that are valid for staking
};

// Possible states for zMONGOCM send
enum ZerocoinSpendStatus {
    ZMONGOCM_SPEND_OKAY = 0,                            // No error
    ZMONGOCM_SPEND_ERROR = 1,                           // Unspecified class of errors, more details are (hopefully) in the returning text
    ZMONGOCM_WALLET_LOCKED = 2,                         // Wallet was locked
    ZMONGOCM_COMMIT_FAILED = 3,                         // Commit failed, reset status
    ZMONGOCM_ERASE_SPENDS_FAILED = 4,                   // Erasing spends during reset failed
    ZMONGOCM_ERASE_NEW_MINTS_FAILED = 5,                // Erasing new mints during reset failed
    ZMONGOCM_TRX_FUNDS_PROBLEMS = 6,                    // Everything related to available funds
    ZMONGOCM_TRX_CREATE = 7,                            // Everything related to create the transaction
    ZMONGOCM_TRX_CHANGE = 8,                            // Everything related to transaction change
    ZMONGOCM_TXMINT_GENERAL = 9,                        // General errors in MintToTxIn
    ZMONGOCM_INVALID_COIN = 10,                         // Selected mint coin is not valid
    ZMONGOCM_FAILED_ACCUMULATOR_INITIALIZATION = 11,    // Failed to initialize witness
    ZMONGOCM_INVALID_WITNESS = 12,                      // Spend coin transaction did not verify
    ZMONGOCM_BAD_SERIALIZATION = 13,                    // Transaction verification failed
    ZMONGOCM_SPENT_USED_ZMONGOCM = 14                       // Coin has already been spend
};
...
public:
    ...
    */
    ...
    void setZMONGOCMAutoBackups(bool fEnabled)
    {
    ...
    /// Get 250000 MONGOcm output and keys which can be used for the Masternode
