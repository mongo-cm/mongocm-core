...
// Copyright (c) 2015-2017 The MONGOcm developers
                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("MONGOcm Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MONGOcm address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and mongocm: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zMONGOCM"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About MONGOcm Core"), this);
    aboutAction->setStatusTip(tr("Show information about MONGOcm Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MONGOcm"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MONGOcm addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MONGOcm addresses"));
    ...
    openAction->setStatusTip(tr("Open a MONGOcm: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MONGOcm Core help message to get a list with possible MONGOcm command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("MONGOcm Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MONGOcm network", "", count));
}
...
{
    QString strTitle = tr("MONGOcm Core"); // default title
