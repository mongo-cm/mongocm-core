                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received MONGOcm from zMONGOCM"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zMONGOCM"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zMONGOCM));
