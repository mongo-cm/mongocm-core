...
/** Utility functions used by the MONGOcm Qt UI.
 */
namespace GUIUtil
{
...
// Render MONGOcm addresses in monospace font
...
// Parse "mongocm:" URI into recipient object, return true on successful parsing
