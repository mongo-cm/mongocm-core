...
Value stop(const Array& params, bool fHelp)
{
    ...
    StartShutdown();
    return "MONGOcm server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MONGOcm features */
        {"mongocm", "masternode", &masternode, true, true, false},
        {"mongocm", "listmasternodes", &listmasternodes, true, true, false},
        {"mongocm", "getmasternodecount", &getmasternodecount, true, true, false},
        {"mongocm", "masternodeconnect", &masternodeconnect, true, true, false},
        {"mongocm", "masternodecurrent", &masternodecurrent, true, true, false},
        {"mongocm", "masternodedebug", &masternodedebug, true, true, false},
        {"mongocm", "startmasternode", &startmasternode, true, true, false},
        {"mongocm", "createmasternodekey", &createmasternodekey, true, true, false},
        {"mongocm", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"mongocm", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"mongocm", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"mongocm", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"mongocm", "getmasternodescores", &getmasternodescores, true, true, false},
        {"mongocm", "mnbudget", &mnbudget, true, true, false},
        {"mongocm", "preparebudget", &preparebudget, true, true, false},
        {"mongocm", "submitbudget", &submitbudget, true, true, false},
        {"mongocm", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"mongocm", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"mongocm", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"mongocm", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"mongocm", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"mongocm", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"mongocm", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"mongocm", "checkbudgets", &checkbudgets, true, true, false},
        {"mongocm", "mnsync", &mnsync, true, true, false},
        {"mongocm", "spork", &spork, true, true, false},
        {"mongocm", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"mongocm", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use mongocmd, or the -server option to mongocm-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> mongocm-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:16382/\n";
}
