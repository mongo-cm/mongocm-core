...
RESOURCES += src/qt/mongocm.qrc src/qt/mongocm_locale.qrc

TRANSLATIONS += src/qt/locale/mongocm_bg.ts \
                src/qt/locale/mongocm_de.ts \
                src/qt/locale/mongocm_en.ts \
                src/qt/locale/mongocm_es.ts \
                src/qt/locale/mongocm_fi.ts \
                src/qt/locale/mongocm_fr.ts \
                src/qt/locale/mongocm_it.ts \
                src/qt/locale/mongocm_ja.ts \
                src/qt/locale/mongocm_pl.ts \
                src/qt/locale/mongocm_pt.ts \
                src/qt/locale/mongocm_ru.ts \
                src/qt/locale/mongocm_sk.ts \
                src/qt/locale/mongocm_sv.ts \
                src/qt/locale/mongocm_vi.ts \
                src/qt/locale/mongocm_zh_CN.ts \
                src/qt/locale/mongocm_zh_TW.ts
